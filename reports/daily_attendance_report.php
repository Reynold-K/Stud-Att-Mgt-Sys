...
// Get total possible attendance (students * subjects) for each day
...
while ($row = mysqli_fetch_assoc($total_possible_result)) {
    $possible_attendance[$row['date']] = $row['possible_attendance'];
}
...
<head>
    ...
    <title>Daily Attendance Analysis</title>
...
<body>
    ...
    <div class="report-header">
        <div class="container">
            <h1><i class="fas fa-calendar-day mr-3"></i>Daily Attendance Analysis</h1>
            <p class="lead">Day-by-day analysis of attendance patterns for the period: <?php echo $formatted_from_date; ?> - <?php echo $formatted_to_date; ?></p>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="report-card">
            <h2 class="section-title">Daily Attendance Details</h2>
            <div class="mb-4">
                <button class="btn btn-primary" onclick="exportTableToExcel('dailyTable', 'Daily_Attendance_<?php echo date('Y-m-d'); ?>')">
                ...
                <table class="table table-striped" id="dailyTable">
                    ...
                    <tbody>
                        ...
                        while ($row = mysqli_fetch_assoc($daily_result)) {
                            ...
                            $possible_attendance_count = isset($possible_attendance[$date]) ? $possible_attendance[$date] : 0;
    ...
    <script>
        ...
        function exportTableToExcel(tableID, filename = '') {
            ...
            const wb = XLSX.utils.table_to_book(table, {sheet: "Daily Attendance"});
